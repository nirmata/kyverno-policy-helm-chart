...
declare -A policies=(
  ...
  [disallow_empty_ingress_host]="https://raw.githubusercontent.com/nirmata/kyverno-policies/refs/heads/main/best-practices-k8s/disallow-empty-ingress-host/disallow_empty_ingress_host.yaml"
